...
![Western dandelion (Taraxacum officinale) — note the reflexed involucral bracts](https://commons.wikimedia.org/wiki/Special:FilePath/Taraxacum_officinale_flowers.jpg)

![Kantō dandelion (Taraxacum platycarpum) — a native species with upright bracts](https://commons.wikimedia.org/wiki/Special:FilePath/Taraxacum_platycarpum_1.JPG)

![Shirobana-tanpopo (Taraxacum albidum) — a native species with distinctive white florets](https://commons.wikimedia.org/wiki/Special:FilePath/Taraxacum_albidum_s3.JPG)
...
![The Asteraceae family — wildly different in appearance, but all share the same secret weapon](/columns/tanpopo-war/asteraceae-grid.svg)
