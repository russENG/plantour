...
const cladeColors: Record<string, Record<string, string>> = {
...
const defaultCladeColors: Record<string, string> = {
  kingdom:"#1e293b", phylum:"#334155", class:"#475569", order:"#64748b", family:"#94a3b8", genus:"#cbd5e1", species:"#f1f5f9",
};
const cladeRootIds = new Set(Object.keys(cladeColors));

const cladeLegend: { id: string; label: string }[] = [
